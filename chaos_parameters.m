...
param.a1 = 5;
param.a2 = 0.1;
param.b1 = 2.55; %2.55; %2.25; % varies between 2 and 6.2
param.b1_r = 2.25:0.001:2.6; %3.6:0.001:4; %2.2:0.01:6.2; %2.25:0.001:2.6;  %2.9:0.01:4.2; 
param.b2 = 2; %1.6; %2;
...
% time steps
param.N = 500000; %10000; 
param.T = 500000; %10000;
...
%param.data = 500000;
%param.delt = 0.01;
%param.tau = param.data*param.delt;
%param.tsteps = [0:(param.tau -1)]*param.delt;
param.ic2 = [1,1,1];
param.sizec = 100;
